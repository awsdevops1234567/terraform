...
root@ip-10-0-0-125:~/class-1/vpc# ls
'1!'   main.tf   terraform.tfstate   terraform.tfstate.backup   vpc.tf
root@ip-10-0-0-125:~/class-1/vpc# cat vpc.tf 
